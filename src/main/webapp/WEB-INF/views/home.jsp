...
<body onload="checkPopup()">
    ...
    <div id="layer_popup1" class="layer_popup" style="top: 50px; left: 50px;">
        <img src="resources/image/213e6fa73233c08f.jpg"
            alt="Popup Image" class="popup_image">
        <div id="check1">
            <input type="checkbox" id="chkbox1"> <label for="chkbox1">&nbsp;오늘 하루동안 안 보기</label>
        </div>
        <div id="close1">
    ...
    <div id="layer_popup2" class="layer_popup" style="top: 100px; left: 100px;">
        <img src="resources/image/213e6fa73233c08f.jpg"
            alt="Popup Image" class="popup_image">
        <div id="check2">
            <input type="checkbox" id="chkbox2"> <label for="chkbox2">&nbsp;오늘 하루동안 안 보기</label>
        </div>
        <div id="close2">
    ...
    <div id="layer_popup3" class="layer_popup" style="top: 150px; left: 150px;">
        <img src="resources/image/213e6fa73233c08f.jpg"
            alt="Popup Image" class="popup_image">
        <div id="check3">
            <input type="checkbox" id="chkbox3"> <label for="chkbox3">&nbsp;오늘 하루동안 안 보기</label>
        </div>
        <div id="close3">
    ...
    <div id="layer_popup4" class="layer_popup" style="top: 200px; left: 200px;">
        <img src="resources/image/213e6fa73233c08f.jpg"
            alt="Popup Image" class="popup_image">
        <div id="check4">
            <input type="checkbox" id="chkbox4"> <label for="chkbox4">&nbsp;오늘 하루동안 안 보기</label>
        </div>
        <div id="close4">
    ...
    <div id="layer_popup5" class="layer_popup" style="top: 250px; left: 250px;">
        <img src="resources/image/213e6fa73233c08f.jpg"
            alt="Popup Image" class="popup_image">
        <div id="check5">
            <input type="checkbox" id="chkbox5"> <label for="chkbox5">&nbsp;오늘 하루동안 안 보기</label>
        </div>
        <div id="close5">
