...
<script type="text/javascript">
	function review_ans_write_ok(f) {
...
<%@include file="../main/header.jsp"%>
	<%@include file="../main/aside_mypage.jsp"%>
		...
		<div>
			<form action=review_ans_write_ok.do method="post" enctype="multipart/form-data">
				<table>
				<tbody>
					<tr>
						<th>제목</th>
			 ...
			 <div class="review_write_button">
				...
				<input type="button" value="답글" onclick="review_ans_write_ok(this.form)" /> 
